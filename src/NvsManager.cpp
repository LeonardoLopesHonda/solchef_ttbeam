...
void NvsManager::inicializarNVS() {
...
bool NvsManager::testarNamespace() {
  Preferences prefs;
...
bool NvsManager::LerNvsWifi(String &ssid, String &key) {
  Preferences prefs;
...
bool NvsManager::GravarNvsWifi(const String &ssid, const String &key) {
  Preferences prefs;
  ...
  Serial.println("Credenciais WiFi gravadas na NVS:");
  Serial.println("SSID: " + ssid);
  return true;
}

void NvsManager::LimparNamespace() {
  Preferences prefs;
